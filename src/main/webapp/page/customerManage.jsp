...
<body style="margin: 1px">   
  <table id="dg" title="客户信息查询" class="easyui-datagrid"  pagination="true" rownumbers="true" 
	...
	<form id="fm" method="post" action="">
		<table cellspacing="8px">
			...
			<tr>
				<td>客户经理：</td>
				<td>
					<input class="easyui-combobox" name="cusManager" id="cusManager" data-options="panelHeight:'auto', editable:false, valueField:'trueName', textField:'trueName', url:'${pageContext.request.contextPath}/user/customerManagerComboList.do'"/>
					<font color="red">*</font>
				</td>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td>客户等级：</td>
				<td>
					<input class="easyui-combobox" name="level" id="level" data-options="panelHeight:'auto', editable:false, valueField:'dataDicValue', textField:'dataDicValue', url:'${pageContext.request.contextPath}/dataDic/findDataDic.do?dataDicName=客户等级'"/>
				</td>
			</tr>
			<tr>
				<td>客户满意度：</td>
...
function openCustomerLinkMan(){
	...
	var row = selectedRows[0];
	window.parent.openTab('客户联系人管理', 'linkManManage.jsp?cusId='+row.id, 'icon-lxr');
}
...
function openCustomerOrder(){
	...
	var row = selectedRows[0];
	window.parent.openTab('客户历史订单查询', 'orderManage.jsp?cusId='+row.id, 'icon-lsdd');
}
