...
<table id="dg" title="客户历史订单" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" 
	url="${pageContext.request.contextPath}/order/list.do?cusId=${param.cusId}" fit="true" style="width: 900px; height: 400px">
  	<thead>
  		<tr>
...
<div id="dlg" class="easyui-dialog" style="width: 700px; height: 450px; padding: 10px 20px" closed="true" buttons="#dlg-buttons">
	...
	<table id="dg2" title="订单订购详情" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" 
		url="${pageContext.request.contextPath}/orderDetails/list.do" fit="true" style="width: 600px; height: 220px">
	  	<thead>
	  		<tr>
	  			<th field="id" width="50" align="center">编号</th>
	  			...
	  			<th field="sum" width="80" align="center" >总金额（元）</th>
	  		</tr>
	  	</thead>
  </table>
