...
<table id="dg" title="联系人信息管理" style="width: 700px; height: 250px"
	...
	<thead>
  		<tr>
  			...
  			<th field="sex" width="50" align="center" editor="{type:'combobox', 
  			options:{
  				valueField : 'id',
  				textField : 'name',
  			...
  			<th field="officePhone" width="100" align="center" editor="{type:'validatebox', options:{required:true}}">办公电话</th>
  			<th field="phone" width="100" align="center" editor="{type:'validatebox', options:{required:true}}">手机</th>
   		</tr>
  	</thead>
