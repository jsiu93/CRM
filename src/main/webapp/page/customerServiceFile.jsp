...
<body style="margin: 1px">   
  ...
  <div id="tb">
 	<div>
 		<a href="javascript:openCustomerServiceFileDialog()" class="easyui-linkbutton" iconCls="icon-fwgd" plain="true">客户服务详情</a>
 	</div>
 	<div>
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		...
   		<tr>
   			<td>服务处理：</td>
   			<td colspan="4">
   				<textarea id="serviceProce" name="serviceProce" rows="5" cols="49" class="easyui-validatebox" required="true" readonly="readonly"></textarea>
   			</td>
   		</tr>
   		<tr>
   			<td>处理人：</td>
   		...
   		<tr>
   			<td>处理结果：</td>
   			<td>
   				<input  id="serviceProceResult" name="serviceProceResult"  required="true" readonly="readonly"/>&nbsp;
   			</td>
   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
   			<td>客户满意度：</td>
   			<td>
