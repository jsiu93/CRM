...
<table id="dg" title="交往记录管理" style="width: 700px; height: 250px"
	...
	<thead>
  		<tr>
  			...
  			<th field="address" width="200" align="center" editor="{type:'validatebox', options:{required:true}}">交往地址</th>
  			<th field="overView" width="300" align="center" editor="{type:'validatebox', options:{required:true}}">概要</th>
   		</tr>
  	</thead>
