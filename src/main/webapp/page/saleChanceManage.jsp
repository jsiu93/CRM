...
<body style="margin: 1px">   
  <table id="dg" title="销售机会信息管理" class="easyui-datagrid" fitColumns="true" pagination="true" rownumbers="true" url="${pageContext.request.contextPath}/saleChance/list.do" fit="true" toolbar="#tb">
  	<thead>
  		<tr>
  			...
  			<th field="assignTime" width="200" align="center" hidden="">指派时间</th>
  			<th field="state" width="80" align="center" formatter="formatState">状态</th>
