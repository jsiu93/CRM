...
<body style="margin: 1px">   
  	...
  	<thead>
  		<tr>
  			<th field="cb" checkbox="true" align="center"></th>
	   		...
	   		<th field="assignTime" width="50" align="center" >分配日期</th>
	   		...
	   		<th field="serviceProceTime" width="50" align="center">服务处理日期</th>
   ...
   <form id="fm" method="post">
   	<table cellspacing="8px">
   		...
   		<tr>
   			<td>服务处理：</td>
   			<td colspan="4">
   				<textarea id="serviceProce" name="serviceProce" rows="5" cols="49" class="easyui-validatebox" required="true"></textarea>
   			</td>
   		</tr>
   		<tr>
   			<td>处理人：</td>
   		...
   		<tr>
   			<td>处理结果：</td>
   			<td>
   				<input  id="serviceProceResult" name="serviceProceResult" class="easyui-validdatebox" required="true"/>&nbsp;
   			</td>
   			<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
   			<td>客户满意度：</td>
   			<td>
 ...
 function openCustomerServiceFeedbackDialog(){
	 ...
	 $("#dlg").dialog("open").dialog("setTitle","处理客户服务反馈");
	 $("#fm").form("load",row);
	 $("#state").val("已归档");
